export default {
  ...
  github: {
    title: 'GitHub存储配置',
    owner: '仓库所有者',
    ownerPlaceholder: '请输入GitHub用户名',
    ownerRequired: '请输入仓库所有者',
    repo: '仓库名称',
    repoPlaceholder: '请输入仓库名称',
    repoRequired: '请输入仓库名称',
    token: '访问令牌',
    tokenPlaceholder: '请输入GitHub Personal Access Token',
    tokenRequired: '请输入访问令牌',
    tokenTip: '需要在GitHub Settings > Developer settings > Personal access tokens 中创建，需要repo权限',
    branch: '分支名称',
    branchPlaceholder: '请输入分支名称',
    branchRequired: '请输入分支名称',
    path: '存储路径',
    pathPlaceholder: '请输入存储路径',
    autoSave: '自动保存',
    configSaved: '配置已保存',
    newFile: '新建文件',
    saveFile: '保存文件',
  ...
  toolbar: {
    ...
    painter: '格式刷',
    github: 'GitHub',
    githubStorage: 'GitHub存储',
    githubStorageEnabled: 'GitHub已开启',
    githubConfig: 'GitHub配置',
    githubFileManager: 'GitHub文件管理',
    formula: '公式',
    attachment: '附件',
    outerFrame: '外框',
    more: '更多',
